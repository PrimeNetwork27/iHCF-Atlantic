...
/**
 * An implementation of a {@link NamedCuboid} that represents land for a
 * {@link Faction} can own.
 */
public class Claim extends NamedCuboid implements Cloneable, ConfigurationSerializable {
	...
	/**
	 * Gets a {@link Subclaim} this {@link Claim} has registered with a specific
	 * name.
	 *
	...
	public String getFormattedName() {
		return getName() + ": (" + worldName + ", " + x1 + ", " + y1 + ", " + z1 + ") - (" + worldName + ", " + x2
				+ ", " + y2 + ", " + z2 + ')';
	}
