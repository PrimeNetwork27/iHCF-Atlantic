...
import com.doctordark.util.scoreboard.nametag.FrozenNametagHandler;
import com.doctordark.util.scoreboard.sidebar.Assemble;
import com.doctordark.util.scoreboard.sidebar.AssembleStyle;
import com.doctordark.util.scoreboard.tablist.shared.TabHandler;
...
import me.scifi.hcf.eventgame.ktk.KTKCommand;
import me.scifi.hcf.eventgame.ktk.KingListener;
...
import me.scifi.hcf.features.abilities.AbilityCommand;
import me.scifi.hcf.features.customtimers.CustomTimerCommand;
import me.scifi.hcf.features.elevators.ElevatorListener;
import me.scifi.hcf.features.lunar.LunarAPI;
import me.scifi.hcf.features.reclaims.ReclaimCommand;
import me.scifi.hcf.features.reclaims.ResetReclaimCommand;
import me.scifi.hcf.features.signs.KitSignListener;
import me.scifi.hcf.features.staffmode.StaffModeCommand;
import me.scifi.hcf.features.staffmode.StaffModeListener;
import me.scifi.hcf.features.staffmode.StaffModeManager;
...
import me.scifi.hcf.scoreboard.GameTabProvider;
import me.scifi.hcf.scoreboard.HCFNametagProvider;
import me.scifi.hcf.scoreboard.ScoreboardProvider;
...
public class HCF extends JavaPlugin {
	...
	private Cooldown assasin = new Cooldown();
	private Rank rank;
	...
	public void onEnable() {
		...
		FrozenNametagHandler.registerProvider(new HCFNametagProvider());
		new BukkitRunnable() {
			@Override
			public void run() {
				saveData();
