package me.scifi.hcf.abilities.type;
...
public class Steroids extends Ability { // TODO: Global Ability Cooldown

	public Steroids() {
		super("anabolics", new Cooldowns("SteroidsCooldown", TimeUtil.parse("30s")), true,
				new ItemBuilder(Material.POTION).displayName("&aStereoids")
						.lore("Use this to gain mass muscle for 5 seconds.").build());
